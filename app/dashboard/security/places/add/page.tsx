...
export default function AddPlacePage() {
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<PlaceFormData>();

  const onSubmit = async (data: PlaceFormData) => {
    setSubmitError("");
    try {
      const response = await api.post('/office_security/places/', data);
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex justify-end items-center mb-6 text-right">
           <div className="text-sm font-bold text-gray-500 flex items-center justify-end gap-2">
             <span className="text-gray-800 font-bold">إضافة مكان</span>
             <span>/</span>
            ...
            <div className="space-y-6 text-right">
              <div>
                ...
                <input 
                  ...
                  placeholder="مثال: برج الأمن المركزي"
              ...
              <div className="flex gap-4 pt-8 justify-end border-t border-gray-100 mt-8">
                ...
                <button 
                  ...
                  className="bg-[#0f172a] hover:bg-gray-800 disabled:bg-gray-500 text-white px-10 py-3 rounded-lg text-sm font-bold transition-colors shadow-sm"
                >
