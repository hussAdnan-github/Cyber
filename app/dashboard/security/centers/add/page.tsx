...
export default function AddCenterPage() {
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<CenterFormData>();
  ...
  const onSubmit = async (data: CenterFormData) => {
    ...
    try {
      ...
      const response = await api.post('/office_security/center/', payload);
        ...
        <div className="flex justify-between items-end mb-6 text-right">
          <div className="flex gap-3">
            ...
            <button 
              ...
              className="bg-[#0f172a] hover:bg-gray-800 disabled:bg-gray-600 text-white px-6 py-2.5 rounded-lg text-sm font-bold transition-colors shadow-sm flex items-center gap-2"
            >
          ...
          <div>
             <div className="flex items-center gap-2 justify-end mb-1">
               <h2 className="text-2xl font-bold text-gray-800">بيانات المركز الأمني</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <input 
                    ...
                    placeholder="مثال: مركز العمليات الشمالي"
