    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-right">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Column 1 (Right visually in RTL, so third in grid if LTR, but we use dir="rtl" later or just order them) */}
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <div className="w-8 h-4 bg-gray-200 rounded-full relative cursor-pointer"><div className="w-4 h-4 bg-white rounded-full border border-gray-300 absolute left-0"></div></div>
                  <span className="text-sm text-gray-600">صفحة الإعدادات</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <tr key={i} className="border-b border-gray-50 hover:bg-gray-50/50">
                  ...
                  {[...Array(6)].map((_, j) => (
                    <td key={j} className="py-3 px-4">
                      <div className="w-8 h-4 bg-gray-200 rounded-full mx-auto relative cursor-pointer">
                        <div className="w-4 h-4 bg-white rounded-full border border-gray-300 absolute left-0"></div>
                      </div>
                    </td>
                  ))}
                </tr>
