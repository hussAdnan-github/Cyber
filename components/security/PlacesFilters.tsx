...
export default function PlacesFilters() {
  ...
  return (
    <form onSubmit={handleFilter} className="flex w-full md:w-auto gap-2">
      <Link href="/dashboard/security/places" className="bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 px-6 py-2.5 rounded-lg text-sm font-bold transition-colors shadow-sm shrink-0 flex items-center justify-center">
          إعادة ضبط
      </Link>
