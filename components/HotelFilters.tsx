...
export default function HotelFilters({ places, users }: HotelFiltersProps) {
      ...
      <div className="flex flex-1 w-full gap-4 text-right order-1 md:order-2 flex-col md:flex-row">
        <div className="flex-1">
          <input 
            ...
            className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 text-right"
            placeholder="بحث باسم الفندق أو الموقع أو المالك..."
            dir="rtl"
          />
        </div>
        <div className="w-full md:w-48">
          <select 
            ...
            dir="rtl"
          >
            <option value="">المكان: الكل</option>
            {places.map(p => (
        ...
        <div className="w-full md:w-48">
          <select 
            ...
            dir="rtl"
          >
            <option value="">المستخدم: الكل</option>
            {users.map(u => (
